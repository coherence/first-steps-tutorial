...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldEntity8 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldEntity8 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldEntity8, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldEntity8(value: { value }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
