...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldVector1 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldVector1 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldVector1, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldVector1(value: { value }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
