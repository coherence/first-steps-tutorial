...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldBool4 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldBool4 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldBool4, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldBool4(number: { number }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
