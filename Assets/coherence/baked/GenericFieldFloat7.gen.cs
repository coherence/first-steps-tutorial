...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldFloat7 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldFloat7 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldFloat7, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldFloat7(number: { number }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
