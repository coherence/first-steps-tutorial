...
namespace Coherence.Generated
{
	...
	public struct ConnectionScene : ICoherenceComponentData
	{
		...
		{
			return $"ConnectionScene(value: {value})";
		}

		public uint GetComponentType() => Definition.InternalConnectionScene;
		...
		public static uint Serialize(ConnectionScene data, uint mask, IOutProtocolBitStream bitStream)
		{
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.value, _value_Min, _value_Max, "ConnectionScene.value");
		...
		public static (ConnectionScene, uint) Deserialize(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
		...
		{
			var last = lastSent as ConnectionScene?;
