...
namespace Coherence.Generated
{
    ...
    public struct ConnectionScene : ICoherenceComponentData
    {
        ...
        public static uint Serialize(ConnectionScene data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        {
            return $"ConnectionScene(value: { value }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
