...
namespace Coherence.Generated
{
    ...
    public struct GenericField2dVector2 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericField2dVector2 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericField2dVector2, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericField2dVector2(value: { value }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
