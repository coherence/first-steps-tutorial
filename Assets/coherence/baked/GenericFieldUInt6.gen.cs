...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldUInt6 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldUInt6 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        {
            return $"GenericFieldUInt6(number: { number }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
