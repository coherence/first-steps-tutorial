...
namespace Coherence.Generated
{
    ...
    public struct Persistence : ICoherenceComponentData
    {
        ...
        public static uint Serialize(Persistence data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        {
            return $"Persistence(Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(0, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(0, '0')})";
        }
    }
