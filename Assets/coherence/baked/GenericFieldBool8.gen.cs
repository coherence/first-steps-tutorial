...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldBool8 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldBool8 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldBool8, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldBool8(number: { number }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
