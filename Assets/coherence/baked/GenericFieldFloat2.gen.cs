...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldFloat2 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldFloat2 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldFloat2, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldFloat2(number: { number }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
