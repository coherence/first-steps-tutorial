...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldEntity7 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldEntity7 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        {
            return $"GenericFieldEntity7(value: { value }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
