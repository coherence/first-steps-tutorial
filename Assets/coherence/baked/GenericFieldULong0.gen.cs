...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldULong0 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldULong0 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        {
            return $"GenericFieldULong0(number: { number }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
