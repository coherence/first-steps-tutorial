...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldBool9 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldBool9 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldBool9, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldBool9(number: { number }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
