...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldEntity3 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldEntity3 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldEntity3, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldEntity3(value: { value }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
