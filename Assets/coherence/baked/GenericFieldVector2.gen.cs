...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldVector2 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldVector2 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldVector2, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldVector2(value: { value }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
