...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldInt8 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldInt8 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        {
            return $"GenericFieldInt8(number: { number }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
