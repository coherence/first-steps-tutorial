...
namespace Coherence.Generated
{
    ...
    public struct Tag : ICoherenceComponentData
    {
        ...
        public static uint Serialize(Tag data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (Tag, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"Tag(tag: { tag }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
