...
namespace Coherence.Generated
{
    ...
    public struct GenericScale : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericScale data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        {
            return $"GenericScale(value: { value }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
