...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldBool2 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldBool2 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldBool2, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldBool2(number: { number }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
