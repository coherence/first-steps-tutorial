...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldFloat0 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldFloat0 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldFloat0, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldFloat0(number: { number }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
