...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldEntity4 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldEntity4 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        {
            return $"GenericFieldEntity4(value: { value }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
