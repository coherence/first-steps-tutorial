...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldEntity5 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldEntity5 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldEntity5, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldEntity5(value: { value }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
