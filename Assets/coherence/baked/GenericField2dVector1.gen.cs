...
namespace Coherence.Generated
{
    ...
    public struct GenericField2dVector1 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericField2dVector1 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericField2dVector1, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericField2dVector1(value: { value }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
