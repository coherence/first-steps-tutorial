...
namespace Coherence.Generated
{
    ...
    {   
        ...
        public override string CoherenceComponentName => "RobotArm_Crate_a0e6252c4d09f4fb28257804194356b6_CoherenceNode_5156161361901559470";
        public override uint FieldMask => 0b00000000000000000000000000000001;
        ...
        {
            var value = ((RobotArm_Crate_a0e6252c4d09f4fb28257804194356b6_CoherenceNode_5156161361901559470)coherenceComponent).path;
        ...
        public override ICoherenceComponentData WriteComponentData(ICoherenceComponentData coherenceComponent, double time)
        {
            var update = (RobotArm_Crate_a0e6252c4d09f4fb28257804194356b6_CoherenceNode_5156161361901559470)coherenceComponent;
            if (RuntimeInterpolationSettings.IsInterpolationNone)
            {
                update.path = Value;
            }
        ...
        public override ICoherenceComponentData CreateComponentData()
        {
            return new RobotArm_Crate_a0e6252c4d09f4fb28257804194356b6_CoherenceNode_5156161361901559470();
        }    
    }
    ...
    {   
        ...
        {
            var value = ((RobotArm_Crate_a0e6252c4d09f4fb28257804194356b6_CoherenceNode_5156161361901559470)coherenceComponent).pathDirtyCounter;
    ...
    public class CoherenceSyncRobotArm_Crate_a0e6252c4d09f4fb28257804194356b6 : CoherenceSyncBaked
    {
        ...
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSyncRobotArm_Crate_a0e6252c4d09f4fb28257804194356b6>();
