...
namespace Coherence.Generated
{
    ...
    public struct GenericScale : ICoherenceComponentData
    {
        ...
        public static unsafe GenericScale FromInteropArchetype_27f1ac5097d4ee4409fbb87ad14f76c2_GenericScale_LOD0(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 12) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 12) " +
