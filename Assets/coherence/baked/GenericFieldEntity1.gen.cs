...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldEntity1 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldEntity1 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldEntity1, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldEntity1(value: { value }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
