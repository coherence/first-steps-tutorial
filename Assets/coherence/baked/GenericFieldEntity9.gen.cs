...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldEntity9 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldEntity9 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldEntity9, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldEntity9(value: { value }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
