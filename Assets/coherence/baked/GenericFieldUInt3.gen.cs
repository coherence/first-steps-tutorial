...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldUInt3 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldUInt3 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldUInt3, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldUInt3(number: { number }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
