...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldBool0 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldBool0 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldBool0, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            return $"GenericFieldBool0(number: { number }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
