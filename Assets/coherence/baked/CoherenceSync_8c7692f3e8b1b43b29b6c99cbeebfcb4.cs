...
namespace Coherence.Generated
{
    ...
    public class Binding_8c7692f3e8b1b43b29b6c99cbeebfcb4_ebc7fcb5251d494c82ab2fed263e609e : RotationBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class Binding_8c7692f3e8b1b43b29b6c99cbeebfcb4_04d6b9c1c7ae4c3584a9f318fb71ec83 : PositionBinding
    {   
        private global::UnityEngine.Transform CastedUnityComponent;
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_8c7692f3e8b1b43b29b6c99cbeebfcb4 : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_8c7692f3e8b1b43b29b6c99cbeebfcb4>();
        
        
        private InputBuffer<_8c7692f3e8b1b43b29b6c99cbeebfcb4> inputBuffer;
        private _8c7692f3e8b1b43b29b6c99cbeebfcb4 currentInput;
        ...
        {
            ["ebc7fcb5251d494c82ab2fed263e609e"] = new Binding_8c7692f3e8b1b43b29b6c99cbeebfcb4_ebc7fcb5251d494c82ab2fed263e609e(),
            ["04d6b9c1c7ae4c3584a9f318fb71ec83"] = new Binding_8c7692f3e8b1b43b29b6c99cbeebfcb4_04d6b9c1c7ae4c3584a9f318fb71ec83(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_8c7692f3e8b1b43b29b6c99cbeebfcb4()
        {
        }
        ...
        public override void ReceiveCommand(IEntityCommand command)
        {
            ...
            {
                default:
                    logger.Warning($"CoherenceSync_8c7692f3e8b1b43b29b6c99cbeebfcb4 Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_8c7692f3e8b1b43b29b6c99cbeebfcb4>();
            this.bridge = bridge;
            this.entityId = entityId;
            this.client = client;        
            coherenceInput = input;
            inputBuffer = new InputBuffer<_8c7692f3e8b1b43b29b6c99cbeebfcb4>(coherenceInput.InitialBufferSize, coherenceInput.InitialInputDelay, coherenceInput.UseFixedSimulationFrames);
        ...
        public override void SendInputState()
        {
            ...
            while (inputBuffer.DequeueForSending(currentSimulationFrame, out long frameToSend, out _8c7692f3e8b1b43b29b6c99cbeebfcb4 input, out bool differs))
            {
        ...
        private bool GetButton(string name, long? simulationFrame)
        {
            ...
            inputBuffer.TryGetInput(frame, out _8c7692f3e8b1b43b29b6c99cbeebfcb4 input);
        ...
        {
            var input = (_8c7692f3e8b1b43b29b6c99cbeebfcb4)entityInput;
