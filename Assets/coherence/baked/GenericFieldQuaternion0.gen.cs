...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldQuaternion0 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldQuaternion0 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        {
            return $"GenericFieldQuaternion0(value: { value }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
