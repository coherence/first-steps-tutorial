...
namespace Coherence.Generated
{
    ...
    public struct ConnectedEntity : ICoherenceComponentData
    {
        ...
        public static uint Serialize(ConnectedEntity data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        {
            return $"ConnectedEntity(value: { value }, pos: { pos }, rot: { rot }, scale: { scale }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(4, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(4, '0')})";
        }
    }
