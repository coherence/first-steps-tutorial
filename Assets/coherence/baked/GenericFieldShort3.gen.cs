...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldShort3 : ICoherenceComponentData
    {
        ...
        public static uint Serialize(GenericFieldShort3 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (GenericFieldShort3, uint) Deserialize(InProtocolBitStream bitStream)
        {
        ...
        {
            var last = lastSent as GenericFieldShort3?;
            
        }

        public override string ToString()
        {
            return $"GenericFieldShort3(number: { number }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
